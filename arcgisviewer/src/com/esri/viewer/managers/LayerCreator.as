...
import com.klspta.flex.map.BaiduLayer;
...
public class LayerCreator
{
    ...
    private static function createLayer(layerCreationProperties:LayerCreationProperties):Layer
    {
		...
		else if (layerType == "baiduPOI")
		{
			return createBaiduPOILayer(layerCreationProperties);
		}
		else if (layerType == "baiduImage")
		{
			return createBaiduImageLayer(layerCreationProperties);
		}
	...
	private static function createBaiduPOILayer(layerCreationProperties:LayerCreationProperties):Layer{
		var POILayer:BaiduLayer = new BaiduLayer("POI");
		return POILayer;
	}
	
	private static function createBaiduImageLayer(layerCreationProperties:LayerCreationProperties):Layer{
		var POILayer:BaiduLayer = new BaiduLayer("POI");
		return POILayer;
	}
}
