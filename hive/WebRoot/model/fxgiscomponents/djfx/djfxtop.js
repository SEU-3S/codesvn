        ...
        buttons: [{
            ...
            handler: function(){
                ...
                if(fp.getForm().isValid()){
                	if(fileType == "shp"|| fileType=="SHP"||fileType=="txt"){
		                fp.getForm().submit({
            ...
            id:'analysis', 
            handler: function(){
            parent.center.frames["lower"].swfobject.getObjectById("FxGIS").identify();
          	  /**
...
function identifyCallback(s){
        ...
        var statusTab = new Ext.Panel({
            ...
            layoutConfig: {animate: true }, 
             items:[{
              title:"查询结果",
               html: "<iframe id='cxjg' style='height:"+(scrHeight-95)+"PX; width:350px;' src='ctxzbfx_jbsx.jsp?myData="+((myData))+"'/>" 
            }]
        }); 
}